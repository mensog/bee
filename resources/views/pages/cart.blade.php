            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div class="cart-aside">
                        <div class="checkout">
                            <h4 class="checkout__heading">Ваша корзина (5)</h4>
                            <div class="checkout__wrap">
                                <span class="checkout__products">Товары:</span>
                                <span class="checkout__products-price">11 000 ₽</span>
                            </div>
                            <div class="checkout__wrap">
                            ...
                            <div class="checkout__wrap">
                                ...
                                <span class="checkout__total-price">111 545 ₽</span>
                            </div>
                            <button class="checkout__btn btn btn-inactive">Перейти к оформлению</button>
                        </div>
                        <div class="promocode">
