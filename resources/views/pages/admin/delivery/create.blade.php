        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form id="productForm" class="form" enctype="multipart/form-data" action="{{ route('admin_create_delivery') }}" method="post">
                        @csrf
                        <div class="card card-bordered style-default-light no-shadow">
                            ...
                            <div class="card-body style-default-bright floating-label">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="text" name="title" class="form-control" id="title" onkeyup="return forceLower(this);" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="number" name="serial_number" class="form-control" id="serial_number" data-rule-digits="true" required>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="time" name="start" class="form-control" id="start" data-rule-time="true" value="00:00" required>
                                            <label for="start">Начало доставки</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="time" name="end" class="form-control" id="end" data-rule-time="true" value="00:00" required>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="number" name="delay" class="form-control" id="delay" data-rule-digits="true">
