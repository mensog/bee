          ...
          <div class="row">
              ...
              <div class="col-4">
                 <div class="expectations__item expectations__item_dark-gray">
                      <div class="expectations__item-title expectations__item-title_white">Упаковка заказов <br> для погрузки</div>
           ...
           <div class="col-6">
             <div class="terms__item">
                ...
                <div class="terms__item-text">У вас хороший ассортимент? Мы его реализуем. <br>
                  Мы уже продаем 10 000 товаров в день</div>
             </div>
           </div>
           <div class="col-6">
             <div class="terms__item">
                <div class="terms__item-title">Без конкурентов</div>
                <div class="terms__item-text">Ведем нишевой отбор поставщиков. Гарантируем сохранить <br> ваши позиции без конкурентов</div>
             </div>
           </div>
           <div class="col-6">
            <div class="terms__item">
