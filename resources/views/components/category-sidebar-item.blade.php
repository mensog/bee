<ul class="catalog__sublist">
    @foreach($childCategories as $category)
        @isset($categories[$category->id])
            ...
            <a class="catalog__sublist-link" href="{{ route($routeName, array_merge(['name' => $category->friendly_url_name] + request()->query())) }}">{{ $category->name }}</a>
            @php
        ...
        @else
            ...
            <a class="catalog__sublist-link" href="{{ route($routeName, ['name' => $category->friendly_url_name] + request()->query()) }}">{{ $category->name }}</a>
        @endisset
    </li>
    @endforeach
</ul>
