                ...
                <div class="col-lg-5">
                    ...
                    <div class="mb-4">
                        <div class="row no-gutters">
                            ...
                            <div class="col pl-3">
                                <div class="font-size-13 font-weight-light">Техническая поддержка</div>
                                <a href="tel:+800" class="font-size-20 text-gray-90">8 (800) 800-00-00</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-gray-14 py-2">
        <div class="container">
            <div class="flex-center-between d-block d-md-flex">
                <div class="mb-3 mb-md-0"><a href="/" class="font-weight-bold text-gray-90">Beeclub</a> © MVP Version
                    0.0.1
                </div>
            </div>
        </div>
