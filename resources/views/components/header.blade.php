         ...
         <div class="header-wrap">
            ...
            <div class="header-right">
               ...
               <div class="header-inner">
                  <div class="dropdown">
                     <a class="catalog-btn btn btn-primary dropdown-toggle {{ (isset($storeCatalog) && $storeCatalog) ? '' : 'dropdown-empty' }}" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     ...
                     <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <ul class="dropdown__mainmenu">
                           ...
                           <li class="dropdown__mainmenu-item menu-last">
                              <a class="dropdown__mainmenu-link" href="{{ route('store_main', $store->slug) }}">
                                 <span class="dropdown-stores__img">
